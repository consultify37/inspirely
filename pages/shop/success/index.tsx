  ...
  return (
    <>
      ...
      <div className='relative flex flex-col justify-center items-center min-h-screen p-7 lg:p-28 gap-2 lg:gap-4 text-center'>
        ...
        <h1 className='lg:text-[32px] font-bold text-secondary'>De asemenea, acestea sunt disponibile și în { currentUser ? <Link href='/cont/comenzi' className='underline underline-offset-1'>contul tău</Link> : 'contul tău'}</h1>
